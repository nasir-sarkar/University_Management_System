...
namespace University_Management_System {
    ...
    public partial class UniversityDataSet2 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Email, string Password, System.DateTime DOB, decimal CGPA, string Program, string Blood, string Gender, string Father, string Mother, string Contact, string Address, string Nationality, string Status) {
...
namespace University_Management_System.UniversityDataSet2TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([Name], [Email], [Password], [DOB], [CGPA], [Program], [Blood], [Gender], [Father], [Mother], [Contact], [Address], [Nationality], [Status]) VALUES (@Name, @Email, @Password, @DOB, @CGPA, @Program, @Blood, @Gender, @Father, @Mother, @Contact, @Address, @Nationality, @Status);
SELECT Student_ID, Name, Email, Password, DOB, CGPA, Program, Blood, Gender, Father, Mother, Contact, Address, Nationality, Status FROM Student WHERE (Student_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Student] SET [Name] = @Name, [Email] = @Email, [Password] = @Passwo" +
                ...
                "ress] = @Address, [Nationality] = @Nationality, [Status] = @Status WHERE (([Stud" +
                "ent_ID] = @Original_Student_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([" +
                "Name] = @Original_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email" +
                "] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Pa" +
                "ssword] = @Original_Password)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB" +
                "] = @Original_DOB)) AND ((@IsNull_CGPA = 1 AND [CGPA] IS NULL) OR ([CGPA] = @Ori" +
                "ginal_CGPA)) AND ((@IsNull_Program = 1 AND [Program] IS NULL) OR ([Program] = @O" +
                "riginal_Program)) AND ((@IsNull_Blood = 1 AND [Blood] IS NULL) OR ([Blood] = @Or" +
                "iginal_Blood)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Or" +
                "iginal_Gender)) AND ((@IsNull_Father = 1 AND [Father] IS NULL) OR ([Father] = @O" +
                "riginal_Father)) AND ((@IsNull_Mother = 1 AND [Mother] IS NULL) OR ([Mother] = @" +
                "Original_Mother)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact]" +
                " = @Original_Contact)) AND ((@IsNull_Nationality = 1 AND [Nationality] IS NULL) " +
                "OR ([Nationality] = @Original_Nationality)) AND ((@IsNull_Status = 1 AND [Status" +
                "] IS NULL) OR ([Status] = @Original_Status)));\r\nSELECT Student_ID, Name, Email, " +
                "Password, DOB, CGPA, Program, Blood, Gender, Father, Mother, Contact, Address, N" +
                "ationality, Status FROM Student WHERE (Student_ID = @Student_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_ID, Name, Email, Password, DOB, CGPA, Program, Blood, Gender, Fath" +
                "er, Mother, Contact, Address, Nationality, Status FROM dbo.Student";
        ...
        public virtual int Fill(UniversityDataSet2.StudentDataTable dataTable) {
        ...
        public virtual UniversityDataSet2.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UniversityDataSet2.StudentDataTable dataTable = new UniversityDataSet2.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UniversityDataSet2.StudentDataTable dataTable) {
        ...
        public virtual int Insert(string Name, string Email, string Password, global::System.Nullable<global::System.DateTime> DOB, global::System.Nullable<decimal> CGPA, string Program, string Blood, string Gender, string Father, string Mother, string Contact, string Address, string Nationality, string Status) {
            if ((Name == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_CGPA.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((decimal)(Original_CGPA.Value));
            }
            else {
            ...
            if ((Original_Program == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((string)(Original_Program));
            }
            if ((Original_Blood == null)) {
            ...
            if ((Original_Father == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[32].Value = ((string)(Original_Father));
            }
            if ((Original_Mother == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((string)(Original_Mother));
            }
            if ((Original_Contact == null)) {
            ...
            if ((Original_Nationality == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[38].Value = ((string)(Original_Nationality));
            }
            if ((Original_Status == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[41].Value = ((int)(Student_ID));
        ...
        public virtual int Update(
                    ...
                    string Original_Nationality, 
                    string Original_Status) {
            return this.Update(Name, Email, Password, DOB, CGPA, Program, Blood, Gender, Father, Mother, Contact, Address, Nationality, Status, Original_Student_ID, Original_Name, Original_Email, Original_Password, Original_DOB, Original_CGPA, Original_Program, Original_Blood, Original_Gender, Original_Father, Original_Mother, Original_Contact, Original_Nationality, Original_Status, Original_Student_ID);
        }
    }
