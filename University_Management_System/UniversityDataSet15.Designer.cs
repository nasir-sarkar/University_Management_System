...
namespace University_Management_System.UniversityDataSet15TableAdapters {
...
SELECT Student_ID, Name, Email, Password, DOB, CGPA, Program, Blood, Gender, Father, Mother, Contact, Address, Nationality, Status, Credit_Completed FROM Student WHERE (Student_ID = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(UniversityDataSet15.StudentDataTable dataTable) {
        ...
        public virtual UniversityDataSet15.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UniversityDataSet15.StudentDataTable dataTable = new UniversityDataSet15.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UniversityDataSet15.StudentDataTable dataTable) {
