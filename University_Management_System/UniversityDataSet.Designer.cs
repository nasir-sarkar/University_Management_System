...
namespace University_Management_System {
    ...
    public partial class UniversityDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string Name, string Email, string Password, System.DateTime DOB, string Status) {
...
namespace University_Management_System.UniversityDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Name], [Email], [Password], [DOB], [Status]) VALUES" +
                " (@Name, @Email, @Password, @DOB, @Status);\r\nSELECT Student_ID, Name, Email, Pas" +
                "sword, DOB, Status FROM Student WHERE (Student_ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Name] = @Name, [Email] = @Email, [Password] = @Password, [DOB] = @DOB, [Status] = @Status WHERE (([Student_ID] = @Original_Student_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Student_ID, Name, Email, Password, DOB, Status FROM Student WHERE (Student_ID = @Student_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student_ID, Name, Email, Password, DOB, Status FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Student_ID, string Original_Name, string Original_Email, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Status) {
        ...
        public virtual int Update(string Name, string Email, string Password, global::System.Nullable<global::System.DateTime> DOB, string Status, int Original_Student_ID, string Original_Name, string Original_Email, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Status, int Student_ID) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Password, global::System.Nullable<global::System.DateTime> DOB, string Status, int Original_Student_ID, string Original_Name, string Original_Email, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Status) {
            return this.Update(Name, Email, Password, DOB, Status, Original_Student_ID, Original_Name, Original_Email, Original_Password, Original_DOB, Original_Status, Original_Student_ID);
        }
    }
